...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
    <div class="stat-card">
        ...
        <p class="text-[11px] text-slate-500 mt-1">Prediksi benar / total sampel</p>
    </div>
    <div class="stat-card">
        ...
        <p class="text-[11px] text-slate-500 mt-1">Ketepatan saat sistem bilang attack</p>
    </div>
    <div class="stat-card">
        ...
        <p class="text-[11px] text-slate-500 mt-1">Attack yang berhasil tertangkap</p>
    </div>
    <div class="stat-card">
...
<div class="card mb-4">
    ...
    <div class="p-5 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-3 text-sm">
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
    <div class="card lg:col-span-1">
        <div class="card-header"><p class="card-title">Confusion Matrix Global</p></div>
        <div class="p-5">
            <div class="grid grid-cols-3 gap-2 text-center text-sm">
                ...
                <div class="p-3 rounded-lg border border-amber-500/30 bg-amber-500/10">
                    <p class="text-2xl font-semibold text-amber-300">{{ $metrics['fn'] }}</p>
                    <p class="text-[10px] text-amber-300/70">FN</p>
                </div>
            ...
            <tbody>
                @forelse ($rows as $row)
                    ...
                    <tr>
                        ...
                        <td class="text-slate-300">{{ ucfirst($row['actual']) }}</td>
                        <td class="text-slate-300">{{ ucfirst($row['predicted']) }}</td>
                        <td class="font-mono">
                            {{ $row['final_score'] ?? '-' }}
                ...
                @empty
                    <tr><td colspan="7" class="text-center py-6 text-slate-500">Belum ada eksperimen dengan ground truth dan status sistem yang siap dievaluasi.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
