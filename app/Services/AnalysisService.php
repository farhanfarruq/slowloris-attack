...
class AnalysisService
{
    ...
    public function analyze(Experiment $experiment): ExtractedFeature
    {
        ...
        $evaluation = $this->scoring->evaluateExperiment($experiment, $features, $radar);
    ...
    public function buildAiPayload(Experiment $experiment): array
    {
        ...
        $radar = $features
            ...
            : ($this->scoring->computeRadarScores($this->scoring->buildFeatures($experiment)));
    ...
    private function buildAiEvidenceContract(
        ...
        $checks = [
            ...
            'relevant_snort_alert' => ((float) ($radarForAi['snort_alert_score'] ?? 0)) >= 30
        ...
        return [
            'allowed_classifications' => ['Normal', 'Suspicious', 'Slowloris Detected', 'Inconclusive'],
            'slowloris_detected_allowed' => $detectionAllowed,
            'required_for_slowloris_detected' => [
